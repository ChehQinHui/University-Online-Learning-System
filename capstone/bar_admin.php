...
<div class="sidebar">
    <ul class="sidebar">
        <li id="dashboard"><a href="dashboard_admin.php">Dashboard</a></li>
        <li id="course"><a href="course.php">Course</a></li>
        ...
        <div class="user-menu" onclick="toggleMenu()">
            <div class="topbar">
                <div class="user-menu" onclick="toggleMenu()">
                    ...
                    <?php 
                        echo isset($_SESSION['admin_fullname']) ? $_SESSION['admin_fullname'] : "Admin"; 
                    ?>
